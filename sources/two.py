...
def generate(model: str, messages, prompt = "You are ChatGPT, a large language model trained by OpenAI. Follow the user's instructions carefully. Respond using markdown.", temperature = 1):
    ...
    headers = {
        ...
        'Origin': 'http://chatgptgateway.dev.munic.io',
        'Referer': 'http://chatgptgateway.dev.munic.io/',
    ...
    response = requests.post('http://chatgptgateway.dev.munic.io/api/chat', headers=headers, json=json_data, verify=False)
